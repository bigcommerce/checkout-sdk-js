...
var AmazonPayShippingStrategy = (function (_super) {
    ...
    AmazonPayShippingStrategy.prototype.initialize = function (options) {
        ...
        this._window.onAmazonPaymentsReady = function () {
            _this._addressBook = _this._createAddressBook(options);
        };
    ...
    AmazonPayShippingStrategy.prototype._createAddressBook = function (options) {
        ...
        var container = options.container, _a = options.onAddressSelect, onAddressSelect = _a === void 0 ? lodash_1.noop : _a, _b = options.onError, onError = _b === void 0 ? lodash_1.noop : _b;
