...
var RemoteCheckoutSelector = (function () {
    ...
    RemoteCheckoutSelector.prototype.getInitializeBillingError = function () {
        return this._remoteCheckout.errors.initializeBillingError;
    };
    RemoteCheckoutSelector.prototype.getInitializeShippingError = function () {
        return this._remoteCheckout.errors.initializeShippingError;
    };
    RemoteCheckoutSelector.prototype.getInitializePaymentError = function () {
    ...
    RemoteCheckoutSelector.prototype.isInitializingBilling = function () {
    ...
    RemoteCheckoutSelector.prototype.isInitializingPayment = function () {
