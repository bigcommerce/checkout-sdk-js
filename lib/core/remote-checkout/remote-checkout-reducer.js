...
function dataReducer(data, action) {
    switch (action.type) {
        case actionTypes.INITIALIZE_REMOTE_BILLING_SUCCEEDED:
            return action.payload.billing ? tslib_1.__assign({}, data, { billingAddress: action.payload.billing.address }) : data;
        case actionTypes.INITIALIZE_REMOTE_SHIPPING_SUCCEEDED:
            return action.payload.shipping ? tslib_1.__assign({}, data, { shippingAddress: action.payload.shipping.address }) : data;
...
function errorsReducer(errors, action) {
    ...
    switch (action.type) {
        ...
        case actionTypes.INITIALIZE_REMOTE_BILLING_SUCCEEDED:
            return tslib_1.__assign({}, errors, { initializeBillingError: undefined });
        case actionTypes.INITIALIZE_REMOTE_BILLING_FAILED:
            return tslib_1.__assign({}, errors, { initializeBillingError: action.payload });
        case actionTypes.INITIALIZE_REMOTE_SHIPPING_REQUESTED:
        case actionTypes.INITIALIZE_REMOTE_SHIPPING_SUCCEEDED:
            return tslib_1.__assign({}, errors, { initializeShippingError: undefined });
        case actionTypes.INITIALIZE_REMOTE_SHIPPING_FAILED:
            return tslib_1.__assign({}, errors, { initializeShippingError: action.payload });
        case actionTypes.INITIALIZE_REMOTE_PAYMENT_REQUESTED:
        case actionTypes.INITIALIZE_REMOTE_PAYMENT_SUCCEEDED:
            return tslib_1.__assign({}, errors, { initializePaymentError: undefined });
        case actionTypes.INITIALIZE_REMOTE_PAYMENT_FAILED:
            return tslib_1.__assign({}, errors, { initializePaymentError: action.payload });
...
function statusesReducer(statuses, action) {
    ...
    switch (action.type) {
        case actionTypes.INITIALIZE_REMOTE_BILLING_REQUESTED:
            return tslib_1.__assign({}, statuses, { isInitializingBilling: true });
        case actionTypes.INITIALIZE_REMOTE_BILLING_SUCCEEDED:
        case actionTypes.INITIALIZE_REMOTE_BILLING_FAILED:
            return tslib_1.__assign({}, statuses, { isInitializingBilling: false });
        case actionTypes.INITIALIZE_REMOTE_SHIPPING_REQUESTED:
            return tslib_1.__assign({}, statuses, { isInitializingShipping: true });
        case actionTypes.INITIALIZE_REMOTE_SHIPPING_SUCCEEDED:
        case actionTypes.INITIALIZE_REMOTE_SHIPPING_FAILED:
            return tslib_1.__assign({}, statuses, { isInitializingShipping: false });
        case actionTypes.INITIALIZE_REMOTE_PAYMENT_REQUESTED:
            return tslib_1.__assign({}, statuses, { isInitializingPayment: true });
        case actionTypes.INITIALIZE_REMOTE_PAYMENT_SUCCEEDED:
        case actionTypes.INITIALIZE_REMOTE_PAYMENT_FAILED:
            return tslib_1.__assign({}, statuses, { isInitializingPayment: false });
        case actionTypes.SIGN_OUT_REMOTE_CUSTOMER_REQUESTED:
