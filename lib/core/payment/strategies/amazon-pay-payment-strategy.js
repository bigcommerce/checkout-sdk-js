...
var AmazonPayPaymentStrategy = (function (_super) {
    ...
    function AmazonPayPaymentStrategy(store, placeOrderService, _remoteCheckoutService, _scriptLoader) {
    ...
    AmazonPayPaymentStrategy.prototype.execute = function (payload, options) {
        ...
        return this._remoteCheckoutService.initializePayment(payload.payment.name, { referenceId: referenceId, useStoreCredit: useStoreCredit })
            .then(function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (referenceId) {
                ...
                walletOptions.onOrderReferenceCreate = function (orderReference) {
                    _this._remoteCheckoutService.setCheckoutMeta(_this._paymentMethod.id, {
    ...
    AmazonPayPaymentStrategy.prototype._handlePaymentSelect = function (orderReference, callback) {
        ...
        this._remoteCheckoutService.synchronizeBillingAddress(this._paymentMethod.id, { referenceId: referenceId })
            .then(function (_a) {
