...
var AmazonPayPaymentStrategy = (function (_super) {
    ...
    AmazonPayPaymentStrategy.prototype.initialize = function (options) {
        ...
        return this._placeOrderService
            .initializePaymentMethod(options.paymentMethod.id, function () {
            return new Promise(function (resolve, reject) {
                ...
                _this._window.onAmazonPaymentsReady = function () {
                    _this._wallet = _this._createWallet(tslib_1.__assign({}, options, { onError: function (error) {
                            onError(error);
                            reject(error);
                        }, onReady: function () {
                            onReady();
    ...
    AmazonPayPaymentStrategy.prototype.execute = function (payload, options) {
        ...
        return this._remoteCheckoutService.initializePayment(payload.payment.name, { referenceId: referenceId })
