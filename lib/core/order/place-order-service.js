...
var PlaceOrderService = (function () {
    ...
    PlaceOrderService.prototype.initializePaymentMethod = function (methodId, initializer) {
        return this._store.dispatch(this._paymentMethodActionCreator.initializePaymentMethod(methodId, initializer));
    };
