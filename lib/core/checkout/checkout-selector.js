...
var CheckoutSelector = /** @class */ (function () {
     ...
     */
    function CheckoutSelector(billingAddress, cart, config, countries, customer, order, paymentMethods, quote, shippingAddress, shippingCountries, shippingOptions) {
     ...
     * @return {boolean}
     */
    CheckoutSelector.prototype.isPaymentRequired = function (useStoreCredit) {
