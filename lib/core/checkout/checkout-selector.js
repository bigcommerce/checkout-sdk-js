...
var CheckoutSelector = (function () {
    ...
    CheckoutSelector.prototype.getCheckoutMeta = function () {
        return this._cacheFactory.get('getCheckoutMeta')
            .retain(function (orderMeta, quoteMeta, isCartVerified, paymentAuthToken) { return (tslib_1.__assign({}, orderMeta, (quoteMeta && quoteMeta.request), { isCartVerified: isCartVerified,
            paymentAuthToken: paymentAuthToken })); })
            .retrieve(this._order.getOrderMeta(), this._quote.getQuoteMeta(), this._cart.isValid(), this._order.getPaymentAuthToken());
    };
