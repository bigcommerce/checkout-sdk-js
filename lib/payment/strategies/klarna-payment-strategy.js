...
var KlarnaPaymentStrategy = (function (_super) {
    ...
    function KlarnaPaymentStrategy(store, placeOrderService, _remoteCheckoutActionCreator, _klarnaScriptLoader) {
    ...
    KlarnaPaymentStrategy.prototype.execute = function (payload, options) {
        ...
        return this._authorize()
            ...
            return _this._store.dispatch(_this._remoteCheckoutActionCreator.initializePayment(payload.payment.name, { authorizationToken: authorizationToken }));
        })
            .then(function () {
