...
var wepay_1 = require("../remote-checkout/methods/wepay");
...
function createPaymentStrategyRegistry(store, client, paymentClient) {
    ...
    registry.register('braintree', function () {
        return new strategies_1.BraintreeCreditCardPaymentStrategy(store, placeOrderService, braintreePaymentProcessor);
    });
    registry.register('braintreepaypal', function () {
        return new strategies_1.BraintreePaypalPaymentStrategy(store, placeOrderService, braintreePaymentProcessor);
    });
    registry.register('braintreepaypalcredit', function () {
        return new strategies_1.BraintreePaypalPaymentStrategy(store, placeOrderService, braintreePaymentProcessor, true);
    });
    registry.register('wepay', function () {
        return new strategies_1.WepayPaymentStrategy(store, placeOrderService, new wepay_1.WepayRiskClient(scriptLoader));
    });
    return registry;
}
