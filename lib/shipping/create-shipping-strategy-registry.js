...
function createShippingStrategyRegistry(store, client) {
    ...
    registry.register('amazon', function () {
        return new strategies_1.AmazonPayShippingStrategy(store, updateShippingService, remoteCheckoutService, new amazon_pay_1.AmazonPayScriptLoader(script_loader_1.getScriptLoader()));
    });
