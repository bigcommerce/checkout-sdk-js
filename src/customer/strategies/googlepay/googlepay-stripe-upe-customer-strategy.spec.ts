...
import { createGooglePayPaymentProcessor, GooglePayPaymentProcessor, GooglePayStripeUPEInitializer } from '../../../payment/strategies/googlepay';
...
import { getStripeUPECustomerInitializeOptions, Mode } from './googlepay-customer-mock';
...
describe('GooglePayCustomerStrategy', () => {
    ...
    describe('#initialize()', () => {
        describe('Payment method exist', () => {
            it('Creates the button', async () => {
                customerInitializeOptions = getStripeUPECustomerInitializeOptions();
            ...
            it('fails to initialize the strategy if no GooglePayCustomerInitializeOptions is provided ', () => {
                customerInitializeOptions = getStripeUPECustomerInitializeOptions(Mode.Incomplete);
            ...
            it('fails to initialize the strategy if no methodid is supplied', () => {
                customerInitializeOptions = getStripeUPECustomerInitializeOptions(Mode.UndefinedMethodId);

                expect(() => strategy.initialize(customerInitializeOptions)).toThrow(InvalidArgumentError);
            });

            it('fails to initialize the strategy if no valid container id is supplied', async () => {
                customerInitializeOptions = getStripeUPECustomerInitializeOptions(Mode.InvalidContainer);
    ...
    describe('#deinitialize()', () => {
        ...
        beforeAll(() => {
            customerInitializeOptions = getStripeUPECustomerInitializeOptions();
            containerId = customerInitializeOptions.googlepaystripeupe ?
                customerInitializeOptions.googlepaystripeupe.container : '';
        });
    ...
    describe('#signOut()', () => {
        ...
        it('successfully signs out', async () => {
            ...
            expect(remoteCheckoutActionCreator.forgetCheckout).toHaveBeenCalledWith('googlepaystripeupe', options);
