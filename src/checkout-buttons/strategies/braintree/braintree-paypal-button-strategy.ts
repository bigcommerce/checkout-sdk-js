...
export default class BraintreePaypalButtonStrategy implements CheckoutButtonStrategy {
    ...
    async initialize(options: CheckoutButtonInitializeOptions): Promise<void> {
        ...
        const paypalMerchantId = paymentMethod?.initializationData?.bannersMerchantId;
        ...
        return Promise.all([
            this._braintreeSDKCreator.getPaypalCheckout({currency: currency?.code, paypalMerchantId}, (paypalCheckoutInstance: PaypalClientInstance) => this._renderButtons(paypalCheckoutInstance)),
