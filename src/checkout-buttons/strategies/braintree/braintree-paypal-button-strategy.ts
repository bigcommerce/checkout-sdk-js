...
export default class BraintreePaypalButtonStrategy implements CheckoutButtonStrategy {
    ...
    async initialize(options: CheckoutButtonInitializeOptions): Promise<void> {
        ...
        const merchantId = paymentMethod?.initializationData?.bannersMerchantId;
        ...
        return Promise.all([
            this._braintreeSDKCreator.getPaypalCheckout({currency: currency?.code, merchantId}, (paypalCheckoutInstance: PaypalClientInstance) => this._renderButtons(paypalCheckoutInstance)),
