            ...
            switch (methodId) {
                case StripeElementType.CreditCard:
                    if (this._useIndividualCardFields && isIndividualCardElementOptions(options)) {
                        ...
                        stripeElement = this._stripeElements.getElement(methodId) || this._stripeElements.create(methodId, options as StripeUPEElementOptions);
