export const LOAD_INTERNAL_ORDER_REQUESTED = 'LOAD_INTERNAL_ORDER_REQUESTED';
export const LOAD_INTERNAL_ORDER_SUCCEEDED = 'LOAD_INTERNAL_ORDER_SUCCEEDED';
export const LOAD_INTERNAL_ORDER_FAILED = 'LOAD_INTERNAL_ORDER_FAILED';
