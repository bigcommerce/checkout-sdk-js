...
declare class BraintreeFastlanePaymentStrategy implements PaymentStrategy {
    ...
    private onError?;
    constructor(paymentIntegrationService: PaymentIntegrationService, braintreeFastlaneUtils: BraintreeFastlaneUtils, browserStorage: BrowserStorage, braintreeSdk: BraintreeSdk);
    /**
     *
     * Default methods
     *
...
declare class BraintreeFastlaneUtils {
    ...
    private methodId?;
    constructor(paymentIntegrationService: PaymentIntegrationService, braintreeIntegrationService: BraintreeIntegrationService, browserStorage: BrowserStorage);
