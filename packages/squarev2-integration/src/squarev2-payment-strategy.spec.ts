...
describe("SquareV2PaymentStrategy", () => {
    ...
    describe("#initialize", () => {
        it("initializes the strategy successfully", async () => {
            ...
            await expect(initialize).resolves.toBe(undefined);
        });
        ...
        it("should initialize the card", async () => {
            ...
            expect(processor.initializeCard).toHaveBeenCalledWith(
                options.squarev2
            );
        });
    ...
    describe("#execute", () => {
        ...
        it("executes the strategy successfully", async () => {
            ...
            await expect(execute).resolves.toBe(undefined);
        });
        ...
        it("should submit the payment", async () => {
            ...
            ).toHaveBeenCalledWith(expectedPayment);
        });
