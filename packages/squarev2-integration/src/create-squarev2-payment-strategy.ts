...
const createSquareV2PaymentStrategy: PaymentStrategyFactory<
    SquareV2PaymentStrategy
> = (paymentIntegrationService) => {
    const useV1 = !paymentIntegrationService.getState().getStoreConfig()
        ?.checkoutSettings.features["PROJECT-4113.squarev2_web_payments_sdk"];
...
export default toResolvableModule(createSquareV2PaymentStrategy, [
    { id: "squarev2" },
]);
