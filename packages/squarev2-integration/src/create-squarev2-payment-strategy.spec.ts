import { NotImplementedError, PaymentIntegrationService } from "@bigcommerce/checkout-sdk/payment-integration-api";
import { getConfig, PaymentIntegrationServiceMock } from "@bigcommerce/checkout-sdk/payment-integrations-test-utils";
...
describe("createSquareV2PaymentStrategy", () => {
    ...
    it("instantiates squarev2 payment strategy", () => {
        ...
        jest.spyOn(paymentIntegrationService.getState(), 'getStoreConfig')
            .mockReturnValueOnce(storeConfigMock);

        const strategy = createSquareV2PaymentStrategy(
    ...
    it("should fail to instantiate squarev2 payment strategy", () => {
        const factory = () => createSquareV2PaymentStrategy(
            paymentIntegrationService
        );
