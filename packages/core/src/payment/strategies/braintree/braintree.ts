...
export interface BraintreePaypalCheckout {
    loadPayPalSDK(config: BraintreePaypalSdkCreatorConfig, renderButtonsCallback: (instance: BraintreePaypalCheckout) => void): void;
 ...
 *
 */
export interface BraintreeVenmoCheckoutCreator extends BraintreeModuleCreator<BraintreeVenmoCheckout, BraintreeVenmoCreatorConfig> {}
