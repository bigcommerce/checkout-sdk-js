...
import { getBNZCustomerInitializeOptions, Mode } from './googlepay-customer-mock';
...
describe('GooglePayCustomerStrategy', () => {
    ...
    describe('#initialize()', () => {
        describe('Payment method exist', () => {
            it('Creates the button', async () => {
                customerInitializeOptions = getBNZCustomerInitializeOptions();
            ...
            it('fails to initialize the strategy if no GooglePayCustomerInitializeOptions is provided ', () => {
                customerInitializeOptions = getBNZCustomerInitializeOptions(Mode.Incomplete);
            ...
            it('fails to initialize the strategy if no methodid is supplied', () => {
                customerInitializeOptions = getBNZCustomerInitializeOptions(Mode.UndefinedMethodId);

                expect(() => strategy.initialize(customerInitializeOptions)).toThrow(InvalidArgumentError);
            });

            it('fails to initialize the strategy if no valid container id is supplied', async () => {
                customerInitializeOptions = getBNZCustomerInitializeOptions(Mode.InvalidContainer);
    ...
    describe('#deinitialize()', () => {
        ...
        beforeAll(() => {
            customerInitializeOptions = getBNZCustomerInitializeOptions();
            containerId = customerInitializeOptions.googlepaybnz ?
                customerInitializeOptions.googlepaybnz.container : '';
        });
    ...
    describe('#signOut()', () => {
        ...
        it('successfully signs out', async () => {
            ...
            expect(remoteCheckoutActionCreator.forgetCheckout).toHaveBeenCalledWith('googlepaybnz', options);
