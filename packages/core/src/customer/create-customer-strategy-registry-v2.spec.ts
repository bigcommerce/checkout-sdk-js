import { CustomerStrategy, PaymentIntegrationService, toResolvableModule } from '@bigcommerce/checkout-sdk/payment-integration';
...
describe('createCustomerStrategyRegistry', () => {
    ...
    it('creates registry with factories pre-registered', () => {
        ...
        const registry = createCustomerStrategyRegistry(
