import { CustomerStrategy, CustomerStrategyFactory, CustomerStrategyResolveId, isResolvableModule, PaymentIntegrationService } from '@bigcommerce/checkout-sdk/payment-integration';
