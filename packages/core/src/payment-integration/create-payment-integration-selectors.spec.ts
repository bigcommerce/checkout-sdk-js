...
describe("createPaymentIntegrationSelectors", () => {
    describe("PaymentIntegrationSelectors", () => {
        ...
        beforeEach(() => {
            internalSelectors = createInternalCheckoutSelectors(
        ...
        it("returns copy of card instrument", () => {
            ...
            expect(output).toEqual(
                internalSelectors.instruments.getCardInstrument("123")
            );
            expect(output).not.toBe(
                internalSelectors.instruments.getCardInstrument("123")
            );
        ...
        it("returns payment status", () => {
            ...
            expect(output).toEqual(
                internalSelectors.payment.getPaymentStatus()
            );
        });
        ...
        it("returns payment redirect URL", () => {
            ...
            expect(output).toEqual(
                internalSelectors.payment.getPaymentRedirectUrl()
            );
        });
        ...
        it("throws if payment method is missing", () => {
            ...
            expect(() =>
                subject.getPaymentMethodOrThrow("braintree")
            ).toThrow();
        });
        ...
        it("returns is payment data required", () => {
            ...
            expect(output).toEqual(
                internalSelectors.payment.isPaymentDataRequired()
            );
        });
        ...
        it("returns is payment data initialized", () => {
            ...
            expect(output).toEqual(
                internalSelectors.paymentStrategies.isInitialized("braintree")
            );
        });
    });
});
