import { CheckoutButtonStrategy, PaymentIntegrationService, toResolvableModule } from '@bigcommerce/checkout-sdk/payment-integration';
...
describe('createCheckoutButtonStrategyRegistry', () => {
    ...
    it('creates registry with factories pre-registered', () => {
        ...
        const registry = createCheckoutButtonStrategyRegistry(
