...
export default class PaypalCommerceButtonStrategy implements CheckoutButtonStrategy {
    ...
    private async _handleOnCancel(_data: OnCancelData) {
        ...
        const shippingAddress = {
            ...
            stateOrProvince: '',
            stateOrProvinceCode: '',
            countryCode: this._shippingData?.countryCode || '',
            postalCode: this._shippingData?.postalCode || '',
    ...
    private async _onHostedMethodApprove(data: ApproveDataOptions, actions: ApproveActions) {
        try {
            ...
            const shippingAddress = {
                ...
                stateOrProvince: '',
                stateOrProvinceCode: '',
                city: this._currentShippingAddress?.city || '',
                countryCode: this._currentShippingAddress?.countryCode || '',
                postalCode: this._currentShippingAddress?.postalCode || '',
                phone: '',
                company: '',
                customFields: []
            };
