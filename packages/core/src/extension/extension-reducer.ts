...
function errorsReducer(
    ...
    switch (action.type) {
        ...
        case ExtensionActionType.PostMessageSucceeded:
            return objectSet(errors, 'postMessageError', undefined);
        ...
        case ExtensionActionType.PostMessageFailed:
            return objectSet(errors, 'postMessageError', action.payload);
