...
export default class HummPaymentStrategy implements PaymentStrategy {
    ...
    private handleOffsiteRedirectResponse(response: OffsiteRedirectResponse): Promise<never> {
        ...
        return new Promise(() => {
            console.log('this.formPoster.postForm called');
            // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
            this.formPoster.postForm(url, JSON.parse(data));
        });
    }
