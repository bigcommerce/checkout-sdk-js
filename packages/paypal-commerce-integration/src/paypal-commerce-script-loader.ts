...
export default class PayPalCommerceScriptLoader {
    ...
    private getPayPalSdkScriptConfigOrThrow(
        ...
        const enabledAlternativePaymentMethodsWithoutRemoved = this.removeElements(enabledAlternativePaymentMethods);
        console.log(enabledAlternativePaymentMethodsWithoutRemoved);
        ...
        const enableAPMsFunding = shouldEnableAPMs ? enabledAlternativePaymentMethodsWithoutRemoved : [];
        ...
        return {
            ...
            commit,
            components: ['buttons', 'hosted-fields', 'messages', 'payment-fields', 'legal'], //TODO: FIX
