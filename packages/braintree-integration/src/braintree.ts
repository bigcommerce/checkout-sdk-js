 ...
 *
 */
export type BraintreeConnectCreator = BraintreeModuleCreator<BraintreeConnect, BraintreeConnectConfig>;
...
export interface BraintreeConnect {
    ...
    ConnectCardComponent: (options: BraintreeConnectCardComponentOptions) => BraintreeConnectCardComponent,
}
...
export interface BraintreeConnectIdentity {
    ...
    triggerAuthenticationFlow(customerId: string, options?: BraintreeConnectAuthenticationOptions): Promise<BraintreeConnectAuthenticationCustomerResult>;
}
...
export interface BraintreeConnectAuthenticationCustomerResult {
    authenticationState: 'succeeded'|'failed'|'canceled';
