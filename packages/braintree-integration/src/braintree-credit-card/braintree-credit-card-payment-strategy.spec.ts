...
import {
    MissingDataError, OrderFinalizationNotRequiredError, PaymentInitializeOptions,
...
describe('BraintreeCreditCardPaymentStrategy', () => {
    ...
    describe('#execute()', () => {
        ...
        //         jest.spyOn(braintreeHostedForm, 'validate');
        ...
        //         await braintreeCreditCardPaymentStrategy.execute(getOrderRequestBody());
        //
        //         expect(braintreeHostedForm.tokenize).toHaveBeenCalledWith(
        //             getBillingAddress(),
        //         );
        //
        //         expect(paymentIntegrationService.submitPayment).toHaveBeenCalledWith({
