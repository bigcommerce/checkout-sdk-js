...
import BigCommerceFastlaneCustomerInitializeOptions, {
...
export default class BigCommerceFastlaneCustomerStrategy implements CustomerStrategy {
    ...
    async initialize(
        options: CustomerInitializeOptions & WithBigCommerceFastlaneCustomerInitializeOptions,
    ): Promise<void> {
    ...
    private getFastlaneStyles(
        methodId: string,
        bigcommerce_payments_fastlane: BigCommerceFastlaneCustomerInitializeOptions | undefined,
