...
describe('BigCommerceFastlanePaymentStrategy', () => {
    ...
    beforeEach(async () => {
        ...
        paypalCommerceRequestSender = new BigCommerceRequestSender(createRequestSender());
        paypalCommerceSdk = createPayPalCommerceSdk();
        paypalCommerceFastlaneUtils = createPayPalCommerceFastlaneUtils();

        strategy = new BigCommerceFastlanePaymentStrategy(
            paymentIntegrationService,
