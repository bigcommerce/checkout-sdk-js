...
export interface StripeLinkV2Client extends Omit<StripeUPEClient, 'elements' | 'confirmPayment'> {
    elements(options: StripeLinkV2Options): StripeLinkV2Elements;
    confirmPayment(options: StripeLinkV2ConfirmPaymentData): Promise<StripeUpeResult>;
}
