...
describe('ExternalPaymentStrategy', () => {
    ...
    describe('#execute()', () => {
        ...
        it('submits order without payment data', async () => {
            ...
            expect(paymentIntegrationService.submitOrder).toHaveBeenCalledWith(omit(payload, 'payment'), options);
            expect(paymentIntegrationService.submitPayment).toHaveBeenCalledWith({...payment, paymentData});
        });
